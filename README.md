...
## Навыки и технологии
- Инструменты анализа данных: ``SQL``, ``Excel``, ``Excel.Power Query``, ``Excel.Power Pivot``, ``VBA``, ``Jupiter Notebook`` 
...
> [Видео-пример](https://drive.google.com/file/d/1Pktssjxd2Ox6j7FYwrGO_F64G9cTi3IS/view?usp=sharing "Проект 6.2 Сортировка сайта")
> 
...
> [Видео-пример](https://drive.google.com/file/d/1CDJa4cw8eWCuwSCi8TaEBImMqrvVRmfT/view?usp=sharing "Проект 6.2 Сортировка сайта")
>
